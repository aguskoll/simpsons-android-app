...
object Dependencies {
    ...
    object Network {
        ...
        // Using the BOM for version management, so we don't need to specify version here
    ...
    object ClassPaths {
        const val GRADLE = "com.android.tools.build:gradle:8.12.0"
